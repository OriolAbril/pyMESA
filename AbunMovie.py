...
n = subp.add_parser('simp',help='Import results from single files',parents=[par,mpar])
n.set_defaults(which='abun')
a = subp.add_parser('byA',help='Import results from single files',parents=[par])
a.set_defaults(which='byA')
s = subp.add_parser('byA-s',help='Import results from single files',parents=[par])
