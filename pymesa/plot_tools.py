...
class CustomPlot:
    ...
    def __init__(self,title='',xlabel='',ylabel='',
                 xrng=None,yrng=None,xlogscale=False,ylogscale=False):
        self.title = title
        self.xlabel = xlabel
        self.ylabel = ylabel
        self.xlim = xrng
...
class pqgCustomPlot(CustomPlot):
    ...
    '''
    def __init__(self,wtitle='pyMESA',title='',xlabel='',ylabel='',
                 xrng=None,yrng=None,xlogscale=False,ylogscale=False):
        CustomPlot.__init__(self,title,xlabel,ylabel,
                            xrng,yrng,xlogscale,ylogscale)
        self.wtitle = wtitle
